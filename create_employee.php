    ...
    if(in_array($fileactualExt,$allowed) && $_SESSION['email']==$emailid)
    {
        if($fileerror==0)
        {
            if($filesize<1000000)
            {
                ...
                // echo "H";
                $insertquery3="INSERT INTO `employee` (`ename`, `city`, `contactno`, `eemail`, `dob`, `interest1`, `interest2`, `interest3`, `experience`, `about`, `education`, `profilepic`) VALUES ('$ename', '$city', '$contactno', '$emailid', '$dob', '$interest1', '$interest2', '$interest3', '$experience', '$about', '$education', '$destfile')";
                $res1=mysqli_query($conn,$insertquery3);
